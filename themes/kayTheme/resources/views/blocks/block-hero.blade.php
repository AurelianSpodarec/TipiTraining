...
<div class="hero relative py-32 bg-cover bg-no-repeat bg-center" style="background-image: url(https://storybrand.com/wp-content/uploads/2019/03/Watch-Video.jpg);">
    ...
    <div class="px-5 py-32 text-white lg:flex h-full lg:items-center justify-center flex-col lg:text-center">
        
        <div><img class="mb-2" src="https://storybrand.com/wp-content/uploads/2020/03/live-stream-icon-2.png" alt="alt" /></div>
        <h1 class="text-5xl font-bold mb-4">{!! get_sub_field('title') !!}</h1>
        <h2 class="text-2xl mb-4">{!! get_sub_field('subtitle') !!}</h2>
